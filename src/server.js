...
require("./cron/noShowChecker"); // Check overdue bookings every minute
// connect DB
connectDB();
...
app.use(
  ...
  require("./routes/v1/adminMembershipPlans")
);
...
app.use("/api/v1/contact", require("./routes/v1/contactRoutes"));
